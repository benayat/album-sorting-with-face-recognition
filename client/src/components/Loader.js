...
const Loader = (props) => {
  return (
    <div className={`dimmPage  ${props.loading ? "active" : "disable"}`}>
      <div className={`loader`}>
        <ul>
          ...
          <li>
            did you know? to make the model that sorts your albums, over a
            hundred thouthand photos <img alt="album" src={albumImg} /> where
            fed to it.
          </li>
          <li>
            {" "}
            ...
            <img alt="family" src={familyImg} /> members, and try to find a
            match
          </li>
        </ul>
      </div>
